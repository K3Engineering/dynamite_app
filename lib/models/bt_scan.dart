...
enum BtLinkState {
  ...
  /// usable. An unreadable or unparseable ADC config, a failed KVS bring-up,
  /// or an invalid flash document (the parse is strict) tears the link down
  /// here (see `BleLinkManager._readAdcConfig` and `_setupKvs`).
  readingConstants,
